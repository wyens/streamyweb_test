...
import { PressableFocusView } from './PressableFocusView.tsx';
import { IptvChannelNameView } from './IptvChannelNameView.tsx';
...
const ThumbSkeleton: React.FC = () => {
  ...
  const bg = pulse.interpolate({
    inputRange: [0.5, 1],
    outputRange: ['rgba(255,255,255,0.05)', 'rgba(255,255,255,0.10)'],
  }) as unknown as string;

  return <Animated.View style={[styles.thumbSkeleton, { backgroundColor: bg }]} />;
};
